...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.imHolderContents.setGeometry(QtCore.QRect(0, 0, 607, 492))
        ...
        self.optionsHolderContents.setGeometry(QtCore.QRect(0, 0, 154, 492))
        ...
        self.backgroundColorChange = ClickableGraphicsView(self.colorChange)
        ...
        self.foregroundColorChange = ClickableGraphicsView(self.colorChange)
